# Contributing to the I Would Like A Raise Email Template
...
The [issue tracker](https://github.com/johnpolacek/I-Would-Like-A-Raise-Email-Template/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/I-Would-Like-A-Raise-Email-Template.git
   # Navigate to the newly cloned directory
   cd I-Would-Like-A-Raise-Email-Template
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/johnpolacek/I-Would-Like-A-Raise-Email-Template.git
   ```
